...
/*
public class RecommendMoreAdapter {
}
*/
public   class RecommendMoreAdapter extends RecyclerView.Adapter<RecommendMoreAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public RecommendMoreAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
