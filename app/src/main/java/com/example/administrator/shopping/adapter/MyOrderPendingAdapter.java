...
/*public class MyOrderPendingAdapter {
}*/
public   class MyOrderPendingAdapter extends RecyclerView.Adapter<MyOrderPendingAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public MyOrderPendingAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
