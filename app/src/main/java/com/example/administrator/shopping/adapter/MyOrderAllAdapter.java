...
public   class MyOrderAllAdapter extends RecyclerView.Adapter<MyOrderAllAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public MyOrderAllAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
