...
/*public class MyOrderWaitGainAdapter {
}*/
public   class MyOrderWaitGainAdapter extends RecyclerView.Adapter<MyOrderWaitGainAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public MyOrderWaitGainAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
