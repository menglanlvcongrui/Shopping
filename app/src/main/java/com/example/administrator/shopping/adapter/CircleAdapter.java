...
public   class CircleAdapter extends RecyclerView.Adapter<CircleAdapter.MyHolder> {
    ...
    public CircleAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = inflater.inflate(R.layout.item_circle, null);
...
/* List<String> imgs = list.get(position).getImgs();
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            tv1 = (TextView) itemView.findViewById(R.id.tv_costume);
            tv2 = (TextView) itemView.findViewById(R.id.tv_costume_details);
