...
/*
public class RecommendLowAdapter {
}
*/
public   class RecommendLowAdapter extends RecyclerView.Adapter<RecommendLowAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public RecommendLowAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
