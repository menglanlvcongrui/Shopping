...
import com.example.administrator.shopping.adapter.MyOrderObligationAdapter;
...
public class MyOrderObligationFragment extends Fragment {
    private RecyclerView rcv;
    private ArrayList<CircleBean.DataBean> list = new ArrayList<>();
    private MyOrderObligationAdapter adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_my_order_obligation, container, false);
    }
...
//初始化数据
        initDatas();
//设置适配器
        adapter = new MyOrderObligationAdapter(getContext(), list);
