...
import com.example.administrator.shopping.adapter.MyOrderWaitGainAdapter;
...
public class MyOrderWaitGainFragment extends Fragment {

    private RecyclerView rcv;
    private ArrayList<CircleBean.DataBean> list = new ArrayList<>();
    private MyOrderWaitGainAdapter adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_my_order_wait_gain, container, false);
    }
...
//初始化数据
        initDatas();
//设置适配器
        adapter = new MyOrderWaitGainAdapter(getContext(), list);
