...
/*
public class TheLatestLookMoroAdapter {
}
*/
public   class TheLatestLookMoroAdapter extends RecyclerView.Adapter<TheLatestLookMoroAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public TheLatestLookMoroAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
