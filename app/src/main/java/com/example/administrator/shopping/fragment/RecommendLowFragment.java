...
/*
public class RecommendLowFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_recommend_low, container, false);
    }
}
*/
public class RecommendLowFragment extends Fragment {
    ...
    private RecommendLowAdapter adapter;
...
//初始化数据
        initDatas();
//设置适配器
        adapter = new RecommendLowAdapter(getContext(),list);
