...
/*public class RecommendHighAdapter {
}*/
public   class RecommendHighAdapter extends RecyclerView.Adapter<RecommendHighAdapter.MyHolder> {
    private Context mcontext;
    private ArrayList<CircleBean.DataBean> list;
    private LayoutInflater inflater;

    public RecommendHighAdapter(Context context, ArrayList<CircleBean.DataBean> list) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = inflater.inflate(R.layout.item_recommend_high, null);
